    ...
    <View style={styles.container}>
      <View style={styles.nameCity}>
        <Avatar.Image
          ...
          source={{
            uri:
              props.postBy?.proImgLink ||
              "https://plus.unsplash.com/premium_photo-1677094311455-b46a51b52dd0?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          }}
        />
        <View>
          <Pressable
